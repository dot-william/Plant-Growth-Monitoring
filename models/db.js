...
const database = {
    ...
    */
    createTable : function (data, location) {
        let sql = `CREATE TABLE ${location}(id INT(11) AUTO_INCREMENT, datetime DATETIME, expt_num TINYINT(1), sitename VARCHAR(20), type VARCHAR(25), index TINYINT(1), value FLOAT, PRIMARY KEY (id))`;
