...
const database = {
    ...
    */
    createTable : function (data, location) { 
        let sql = `CREATE TABLE ${location}(id INT AUTO_INCREMENT, datetime DATETIME, expt_num TINYINT(1), sitename VARCHAR(20), type VARCHAR(25), sensor_idx TINYINT(1), value FLOAT(5), PRIMARY KEY (id))`;
